...
export interface GameQuestion { id: string; statement: string; optionA: string; optionB: string; correctAnswer: DoorChoice; explanation: string; difficulty: 'basic' | 'intermediate' | 'advanced'; optionIds?: [string, string]; }
