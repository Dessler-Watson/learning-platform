...
export function Path({ length = 480 }: { length?: number }) {
  ...
  return (
    <group>
      {/* Main path body */}
      <RigidBody type="fixed" position={[0, Y, centerZ]} friction={0.8}>
      ...
      <mesh position={[0, Y - 0.35, centerZ]}>
      ...
      <RigidBody type="fixed" position={[-WIDTH / 2 - 0.3, WALL_H / 2, centerZ]}>
