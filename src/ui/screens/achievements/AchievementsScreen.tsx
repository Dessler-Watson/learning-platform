    ...
    <main style={{ minHeight: '100vh', position: 'relative' }}>
      ...
      <motion.div variants={c} initial="hidden" animate="show"
        ...
        <motion.div variants={it} style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 20 }}>
          ...
          <div>
            <h1 style={{ color: '#344054', fontSize: 22, fontWeight: 800, margin: 0, fontFamily: "var(--font-baloo), system-ui, sans-serif" }}>Logros</h1>
        ...
        <motion.div variants={it} style={{
          ...
          <div style={{ flex: 1 }}>
            <div style={{ color: '#344054', fontSize: 20, fontWeight: 800, fontFamily: "var(--font-baloo), system-ui, sans-serif" }}>{done} de {total}</div>
