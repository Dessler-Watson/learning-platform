...
const navItems = [
  { label: 'Inicio', href: '/panel', icon: House, color: 'text-cyan-500' },
  { label: 'Salas', href: '/panel/salas', icon: DoorOpen, color: 'text-emerald-500' },
  { label: 'Perfil', href: '/panel/perfil', icon: UserRound, color: 'text-pink-500' },
];

const adminNavItems = [
  { label: 'Administrar docentes', href: '/panel/admin/docentes', icon: ShieldCheck, color: 'text-amber-500' },
];
          ...
          return (
            <button
              ...
              className={cn(
                ...
                active
                  ? 'bg-white/80 text-cyan-500 shadow-md shadow-cyan-500/10 border border-cyan-100'
            ...
            >
              {active && (
                <motion.span
                  ...
                  className="absolute left-0 top-1/2 h-6 w-[3px] -translate-y-1/2 rounded-full bg-cyan-400"
              ...
              <div className={cn(
                ...
                <item.icon className={cn(
                  ...
                  active ? 'text-cyan-500' : item.color === 'text-amber-500' ? 'text-amber-400 group-hover:text-amber-500' : 'text-gray-400 group-hover:text-foreground'
                )} />
              </div>
              <AnimatePresence mode="wait">
                {showLabels && (
